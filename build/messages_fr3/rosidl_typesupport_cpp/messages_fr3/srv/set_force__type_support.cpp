...
static const _SetForce_Request_type_support_symbol_names_t _SetForce_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages_fr3, srv, SetForce_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages_fr3, srv, SetForce_Request)),
  }
};
...
{
  return &::messages_fr3::srv::rosidl_typesupport_cpp::SetForce_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, messages_fr3, srv, SetForce_Request)() {
  return get_message_type_support_handle<messages_fr3::srv::SetForce_Request>();
}
...
static const _SetForce_Response_type_support_symbol_names_t _SetForce_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages_fr3, srv, SetForce_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages_fr3, srv, SetForce_Response)),
  }
};
...
{
  return &::messages_fr3::srv::rosidl_typesupport_cpp::SetForce_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, messages_fr3, srv, SetForce_Response)() {
  return get_message_type_support_handle<messages_fr3::srv::SetForce_Response>();
}
...
static const _SetForce_type_support_symbol_names_t _SetForce_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages_fr3, srv, SetForce)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages_fr3, srv, SetForce)),
  }
};
...
{
  return &::messages_fr3::srv::rosidl_typesupport_cpp::SetForce_service_type_support_handle;
}
