...
class Metaclass_SetParam(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from messages_fr3.srv import _set_param
...
class SetParam(metaclass=Metaclass_SetParam):
    from messages_fr3.srv._set_param import SetParam_Request as Request
    from messages_fr3.srv._set_param import SetParam_Response as Response
