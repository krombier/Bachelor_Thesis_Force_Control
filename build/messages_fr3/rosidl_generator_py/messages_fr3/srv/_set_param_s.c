...
bool messages_fr3__srv__set_param__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("messages_fr3.srv._set_param.SetParam_Request", full_classname_dest, 44) == 0);
  }
  messages_fr3__srv__SetParam_Request * ros_message = _ros_message;
  {  // a
...
PyObject * messages_fr3__srv__set_param__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("messages_fr3.srv._set_param");
...
ROSIDL_GENERATOR_C_EXPORT
bool messages_fr3__srv__set_param__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("messages_fr3.srv._set_param.SetParam_Response", full_classname_dest, 45) == 0);
  }
  messages_fr3__srv__SetParam_Response * ros_message = _ros_message;
  {  // success
