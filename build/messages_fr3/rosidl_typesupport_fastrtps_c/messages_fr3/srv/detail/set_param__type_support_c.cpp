...
#include "messages_fr3/srv/detail/set_param__rosidl_typesupport_fastrtps_c.h"
...
using _SetParam_Request__ros_msg_type = messages_fr3__srv__SetParam_Request;
...
size_t get_serialized_size_messages_fr3__srv__SetParam_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetParam_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_messages_fr3__srv__SetParam_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_messages_fr3
size_t max_serialized_size_messages_fr3__srv__SetParam_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages_fr3__srv__SetParam_Request;
    is_plain =
      (
      offsetof(DataType, f) +
      last_member_size
...
static size_t _SetParam_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_messages_fr3__srv__SetParam_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages_fr3, srv, SetParam_Request)() {
...
using _SetParam_Response__ros_msg_type = messages_fr3__srv__SetParam_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_messages_fr3
size_t get_serialized_size_messages_fr3__srv__SetParam_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetParam_Response__ros_msg_type * ros_message = static_cast<const _SetParam_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_messages_fr3__srv__SetParam_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_messages_fr3
size_t max_serialized_size_messages_fr3__srv__SetParam_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = messages_fr3__srv__SetParam_Response;
    is_plain =
      (
...
static size_t _SetParam_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_messages_fr3__srv__SetParam_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages_fr3, srv, SetParam_Response)() {
...
// already included above
// #include "messages_fr3/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "messages_fr3/srv/set_param.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages_fr3, srv, SetParam)() {
