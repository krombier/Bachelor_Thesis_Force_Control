...
#include "messages_fr3/srv/detail/set_pose__rosidl_typesupport_fastrtps_c.h"
...
using _SetPose_Request__ros_msg_type = messages_fr3__srv__SetPose_Request;
...
static uint32_t _SetPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_messages_fr3__srv__SetPose_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages_fr3__srv__SetPose_Request;
    is_plain =
      (
...
static size_t _SetPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_messages_fr3__srv__SetPose_Request(
...
using _SetPose_Response__ros_msg_type = messages_fr3__srv__SetPose_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_messages_fr3__srv__SetPose_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = messages_fr3__srv__SetPose_Response;
    is_plain =
      (
...
static size_t _SetPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_messages_fr3__srv__SetPose_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "messages_fr3/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "messages_fr3/srv/set_pose.h"
