...
#include "messages_fr3/srv/detail/set_param__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const messages_fr3::srv::SetParam_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  messages_fr3::srv::SetParam_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages_fr3::srv::SetParam_Request;
    is_plain =
      (
      offsetof(DataType, f) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const messages_fr3::srv::SetParam_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<messages_fr3::srv::SetParam_Request *>(
    untyped_ros_message);
...
{
  return &messages_fr3::srv::typesupport_fastrtps_cpp::_SetParam_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages_fr3, srv, SetParam_Request)() {
  return &messages_fr3::srv::typesupport_fastrtps_cpp::_SetParam_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_messages_fr3
cdr_serialize(
  const messages_fr3::srv::SetParam_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  messages_fr3::srv::SetParam_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = messages_fr3::srv::SetParam_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const messages_fr3::srv::SetParam_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<messages_fr3::srv::SetParam_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &messages_fr3::srv::typesupport_fastrtps_cpp::_SetParam_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages_fr3, srv, SetParam_Response)() {
  return &messages_fr3::srv::typesupport_fastrtps_cpp::_SetParam_Response__handle;
}
...
{
  return &messages_fr3::srv::typesupport_fastrtps_cpp::_SetParam__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages_fr3, srv, SetParam)() {
  return &messages_fr3::srv::typesupport_fastrtps_cpp::_SetParam__handle;
}
